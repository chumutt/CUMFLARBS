...
dotfilesrepo="https://github.com/chumutt/voidrice.git"
progsfile="https://raw.githubusercontent.com/chumutt/CUMFLARBS/master/static/progs.csv"
aurhelper="yay"
repobranch="master"
export TERM=ansi
...
installffaddons(){
	addonlist="ublock-origin decentraleyes istilldontcareaboutcookies tridactyl darkreader keepassxc"
	addontmp="$(mktemp -d)"
